...
class RequestsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let deleteAction = UIContextualAction(style: .normal, title:  "Refuse", handler: { (ac:UIContextualAction, view:UIView, success:(Bool) -> Void) in
            
            success(true)
        })
       // deleteAction.image = UIImage(named: "Star")
        deleteAction.backgroundColor = UIColor(red:1.00, green:0.36, blue:0.32, alpha:1.0)
        ...
        //acceptAction.image = UIImage(named: "Star")
       ...
       // chatAction.image = UIImage(named: "Star")
        chatAction.backgroundColor = UIColor(red:0.75, green:0.75, blue:0.75, alpha:1.0)
        
        
        return UISwipeActionsConfiguration(actions: [chatAction, deleteAction, acceptAction])
    }
